...
- 文件数：572，大小约 925.00 MiB。

- 所选 EXE 链接构建时间：`2026-09-16T14:08:19+08:00`。
...
build-manifest.json
"buildId": "1.3.0-path-state-fix-20260916",
"product": "WinIsland 1.3.0 社区版",
```
...
主 EXE 链接时间：`2026-09-16T14:08:19+08:00`。本轮只核对归档字节，不代表重新运行或编译过此历史版本。
