...
void openModManager(HWND parent,ModLoader& loader){
    ...
    else managerWindow=CreateWindowExW(WS_EX_CONTROLPARENT,c.lpszClassName,L"WinIsland · 插件管理 · 1.2.6alpha-c2",WS_OVERLAPPEDWINDOW|WS_CLIPCHILDREN,left,top,width,height,parent,nullptr,c.hInstance,model);
