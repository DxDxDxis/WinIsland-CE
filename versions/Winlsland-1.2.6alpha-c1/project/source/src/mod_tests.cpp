...
int modSystemTest(const fs::path& output){
    ...
    try{
        ...
        check(modVersionMatches("1.2.6alpha-c1",">=1.2.5alpha-r1 <1.3.0"),"host prerelease range matches");check(!modVersionMatches("1.0.0",">=2.0.0"),"dependency version mismatch rejected");
