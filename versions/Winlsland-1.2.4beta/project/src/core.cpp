    ...
    try {
        ...
        if (m.contains(L"LyricSource") &&
            (m[L"LyricSource"] == L"0" || m[L"LyricSource"] == L"1" || m[L"LyricSource"] == L"2" ||
             m[L"LyricSource"] == L"3" || m[L"LyricSource"] == L"4"))
