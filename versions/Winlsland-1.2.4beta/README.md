...
- 筛选说明：本版 release 内按 PE 构建时间选择最新成品。
- 来源路径和内部构建标识详见根目录 catalog；内部修复后缀不属于正式版号。
- 文件数：61，大小约 1.63 MiB。

- 所选 EXE 链接构建时间：`2026-09-07T00:38:50+08:00`。
...
GitHub 用户请从[本版本发行页](https://github.com/DxDxDxis/WinIsland-CE/releases/tag/v1.2.4beta)下载运行包。`dist/` 仅保存在本地完整归档，未放入 Git 源码仓库；下方成品表列出 ZIP 内 EXE 的原始哈希。
...
| 文件 | MiB | SHA-256 |
|---|---:|---|
| [dist/WinIsland-1.2.4beta.exe](https://github.com/DxDxDxis/WinIsland-CE/releases/tag/v1.2.4beta) | 1.04 | `3BBF2F415C200CEF20A97DA987F1B8228FDA0FDD9A6A0266E464448986FD50DA` |

## 身份证据

```text
src/core.h
inline constexpr wchar_t Version[] = L"1.2.4beta";
inline constexpr char BuildId[] = "1.2.4beta-minimized-lyrics-20260907-r8";
```
...
主 EXE 链接时间：`2026-09-07T00:38:50+08:00`。本轮只核对归档字节，不代表重新运行或编译过此历史版本。
