...
- 所选 EXE 链接构建时间：`2026-09-06T16:55:22+08:00`。
...
GitHub 用户请从[本版本发行页](https://github.com/DxDxDxis/WinIsland-CE/releases/tag/v1.2.0)下载运行包。`dist/` 仅保存在本地完整归档，未放入 Git 源码仓库；下方成品表列出 ZIP 内 EXE 的原始哈希。
...
| 文件 | MiB | SHA-256 |
|---|---:|---|
| [dist/WinIsland-1.2.0社区版.exe](https://github.com/DxDxDxis/WinIsland-CE/releases/tag/v1.2.0) | 0.16 | `673645E3C4ADDDE369EBC8416E5A20C0C0268062B3FBD177F01637BE2D19A724` |
...
主 EXE 链接时间：`2026-09-06T16:55:22+08:00`。本轮只核对归档字节，不代表重新运行或编译过此历史版本。
