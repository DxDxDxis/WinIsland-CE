...
GitHub 用户请从[本版本发行页](https://github.com/DxDxDxis/WinIsland-CE/releases/tag/v1.1.2)下载运行包。`dist/` 仅保存在本地完整归档，未放入 Git 源码仓库；下方成品表列出 ZIP 内 EXE 的原始哈希。
...
| 文件 | MiB | SHA-256 |
|---|---:|---|
| [dist/WinIsland-1.1.2社区版.exe](https://github.com/DxDxDxis/WinIsland-CE/releases/tag/v1.1.2) | 0.16 | `54FB571F12509F9E96827BDE872CC92E509565115AB4ADE562165391AE587672` |
